                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="text-slid-box">
                        <div id="offer-box" class="carouselTicker">
                            <ul class="offer-box">
                                <li>
                                    <i class="fab fa-opencart"></i> 20% off Entire Purchase Promo code: offT567
                                </li>
                                <li>
                                    <i class="fab fa-opencart"></i> 50% - 80% off on Beats headphones
                                </li>
                                <li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"> Researchers Account</li>
                    </ul>
                </div>
            </div>
        </div>
...
<div class = "container"> 
	<div class="row">
		...
		<h1 style="color:White;" >Researchers Management</h1>
<div style="background-image: url('yellow.jfif');">
	<form id="formItem" name="formItem"  >
		
		<h2>Name:</h2><input id="Name" name="Name" type="text" class="form-control form-control-sm"><br>
		...
		ConNum:
		<input id="ConNum" name="ConNum" type="text" class="form-control form-control-sm"><br>
...
<br>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        <div class="footer-widget">
                            <h4>About GadgetBadget</h4>
                            <p>We provide your dream items.Visit our shop and make make your future easier with our branded products.</p> 
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        <div class="footer-link-contact">
                            ...
                            <ul>
                                <li>
                                    <p><i class="fas fa-map-marker-alt"></i>Address: GadgetBadget Team <br>Piliyandala Street,<br> Colombo </p>
                                </li>
                                <li>
                                    <p><i class="fas fa-phone-square"></i>Phone: <a href="tel:08144235324">08144235324</a></p>
                                </li>
                                <li>
    ...
    <div class="footer-copyright">
        <p class="footer-company">All Rights Reserved. &copy; 2021 <a href="#">GadgetBadget</a> Design By :
